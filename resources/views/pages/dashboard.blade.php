                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Testing<div class="bullet"></div> 8 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Testing<div class="bullet"></div> 21
                                            Min</div>
                                    </div>
                                </li>
                            </ul>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="font-weight-600"><img
                                                        ...
                                                        alt="avatar"
                                                        width="30"
                                                        class="rounded-circle mr-1"> Testing</a>
                                            </td>
                                            <td>
